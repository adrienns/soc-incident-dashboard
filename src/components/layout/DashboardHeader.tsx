...
export const DashboardHeader = ({ connectionStatus, onLogout }: DashboardHeaderProps) => {
    return (
        <header className="h-16 md:h-20 flex items-center justify-between px-3 md:px-8 bg-content1 flex-shrink-0 z-20">
            <div className="flex items-center gap-2 md:gap-4">
                ...
                <span className="text-sm md:text-2xl font-bold">SOC Incident Dashboard</span>
            </div>
            <div className="flex items-center gap-2 md:gap-5">
                ...
                <Button
                    ...
                    variant="ghost"
                    color="default"
                    className="text-default-400 hover:text-default-500 text-xs md:text-sm"
                    onPress={onLogout}
                >
                    Logout
                </Button>
